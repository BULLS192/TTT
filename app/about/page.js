...
export default function Page(){return <main>
  ...
  <section className="section"><div className="shell decision-split"><div><p className="eyebrow">Vehicle owners</p><h3>Improve the car without making it feel less like your car.</h3><Link className="button button--ghost" href="/industries/vehicle-owners">For Vehicle Owners →</Link></div><div><p className="eyebrow">Dealers & fleets</p><h3>Make the work repeatable enough that the process survives scale.</h3><div className="section-link-row"><Link className="button button--ghost" href="/industries/dealerships">Dealerships</Link><Link className="button button--ghost" href="/industries/fleets">Fleets</Link></div></div></section>
