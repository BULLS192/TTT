...
export default function sitemap(){
  ...
  const staticRoutes=['','/solutions','/services','/industries','/concept-one','/projects','/technology','/vehicles','/resources','/resources/faq','/articles','/shop','/about','/contact','/work-with-us','/start','/privacy','/terms','/accessibility'];
